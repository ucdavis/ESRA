...
/****** Object:  View [dbo].[UCDEmployee]    Script Date: 03/29/2010 09:42:21 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[AllUCDEmployees]'))
DROP VIEW [dbo].[AllUCDEmployees]
GO

USE [ESRA]
GO

/****** Object:  View [dbo].[AllUCDEmployees]    Script Date: 03/29/2010 09:42:22 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[AllUCDEmployees]
AS
SELECT DISTINCT 
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'AllUCDEmployees (view): This purpose of this view is to return a single record for each employee/title code combination.  This data can then be used with ESRA and other similar programs.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'AllUCDEmployees'
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'AllUCDEmployees'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'AllUCDEmployees'
GO
