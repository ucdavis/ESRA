...
REM        "Run all the SQL scripts.bat" null script_path
  ...
  SQLCMD -S %server% -i "%script_path%\Create ESRA from Terry\Create SS Agent Job ESRA dbo.Employee_TimeLenghtsRefresher.sql" -e -o "%script_path%\ESRA Create SS Agent Job output.log"
