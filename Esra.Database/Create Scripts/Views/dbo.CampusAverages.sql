...
/****** Object:  View [dbo].[CampusAverages]    Script Date: 03/24/2010 11:20:10 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CampusAverages]'))
DROP VIEW [dbo].[CampusAverages]
GO

USE [ESRA]
GO

/****** Object:  View [dbo].[CampusAverages]    Script Date: 03/24/2010 11:20:11 ******/
SET ANSI_NULLS ON
GO
