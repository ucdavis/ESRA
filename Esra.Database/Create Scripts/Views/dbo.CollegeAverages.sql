...
/****** Object:  View [dbo].[CollegeAverages]    Script Date: 03/24/2010 11:22:48 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[CollegeAverages]'))
DROP VIEW [dbo].[CollegeAverages]
GO
...
CREATE VIEW [dbo].[CollegeAverages]
AS
