...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Departments (view): This view limits the PPS Departments displayed in ESRA to only those that exist in our college, plus a few special cases, i.e. Ag Issues Center 065130.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'Departments'
GO
