...
/****** Object:  Job [ESRA.dbo.Employee_TimeLengthsRefresher]    Script Date: 08/13/2010 10:35:59 ******/
IF  EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'ESRA.dbo.Employee_TimeLengthsRefresher')
DECLARE @MyJobID varchar(500) = (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'ESRA.dbo.Employee_TimeLengthsRefresher')
...
/****** Object:  Job [ESRA.dbo.Employee_TimeLengthsRefresher]    Script Date: 08/13/2010 10:36:00 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 08/13/2010 10:36:00 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [UPDATE TimeInTitle and YearsOfService on existing records]    Script Date: 08/13/2010 10:36:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [INSERT data for all remaining records]    Script Date: 08/13/2010 10:36:00 ******/
...
WHERE
	...
	AND UCDEmployee.PkEmployee NOT IN (SELECT PkEmployee FROM dbo.Employee);', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [UPDATE College and Campus Averages]    Script Date: 08/13/2010 10:36:00 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'UPDATE College and Campus Averages', 
  ...
  where ExperienceBeginDate is null', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [UPDATE IsCAES]    Script Date: 08/13/2010 10:36:00 ******/
...
END)', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [REORGANIZE EmployeeTimeInTitleIDX]    Script Date: 08/13/2010 10:36:00 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'REORGANIZE EmployeeTimeInTitleIDX', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [REORGANIZE Employee_YearsOfServiceIDX]    Script Date: 08/13/2010 10:36:00 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [REORGANIZE Employee_YearsOfExperienceIDX]    Script Date: 08/13/2010 10:36:00 ******/
