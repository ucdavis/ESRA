CREATE VIEW [dbo].[CollegeAverages_20120203_bak]
AS
...
GROUP BY TC
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'CollegeAverages_20120203_bak';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'CollegeAverages_20120203_bak';
