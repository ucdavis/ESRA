CREATE VIEW [dbo].[Catbert3_vUsers]
AS
SELECT DISTINCT 
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Catbert3_vUsers';
